    ...
    m_window(0)
{
    ...
    qCDebug(DISMAN_XRANDR).nospace() << "Detected XRandR " << m_versionMajor << "." << m_versionMinor;
...
void XCBEventListener::handleScreenChange(xcb_generic_event_t* e)
{
    ...
    qCDebug(DISMAN_XRANDR) << "\tRotation: " << rotationToString((xcb_randr_rotation_t) e2->rotation);
...
void XCBEventListener::handleXRandRNotify(xcb_generic_event_t* e)
{
    ...
    if (randrEvent->subCode == XCB_RANDR_NOTIFY_CRTC_CHANGE) {
        ...
        qCDebug(DISMAN_XRANDR) << "\tRotation: " << rotationToString((xcb_randr_rotation_t) crtc.rotation);
        ...
        qCDebug(DISMAN_XRANDR) << "\tRotation: " << rotationToString((xcb_randr_rotation_t) output.rotation);
        qCDebug(DISMAN_XRANDR) << "\tConnection: " << connectionToString((xcb_randr_connection_t) output.connection);
