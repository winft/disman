...
standard-version -t disman\@ --skip.commit true --skip.tag true --preMajor --release-as $PATCH_VERSION
...
git tag -a "disman@${PATCH_VERSION}" -m "Create patch release ${PATCH_VERSION}."
