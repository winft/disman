...
standard-version -t disman\@ --skip.commit true --skip.tag true --preMajor --release-as $BETA_VERSION
...
git tag -a "disman@${BETA_VERSION}" -m "Create beta release ${BETA_VERSION}."
